...
const USAGE: &str = "usage:
  ...
  fundacad-engine golden-check <golden.json> [--corpus <corpus.json>] [--record <names>] [--record-platform <names>] [--warm]
                                          ...
                                          --record-platform <names> keeps this engine's
                                          answers beside python's, for this OS only;
