...
Please use GitHub's private reporting: the **Report a vulnerability** button under the repository's [Security tab](https://github.com/Paraxdev/fundacad/security/advisories/new). Do not open a public issue for anything security-sensitive.
