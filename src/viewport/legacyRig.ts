// The camera-controls rig, kept for one release behind `?nav=legacy` while the
// navigator (./navigator) replaces it. Perspective and orthographic cameras are
// kept in parallel and the toggle preserves apparent zoom.
