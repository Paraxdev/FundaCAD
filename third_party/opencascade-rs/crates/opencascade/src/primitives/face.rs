...
impl Face {
    ...
    pub fn extrude(&self, dir: DVec3) -> Solid {
        ...
        let solid = ffi::topo_ds::Solid(extruded_shape);
    ...
    pub fn revolve(&self, origin: DVec3, axis: DVec3, angle: Option<Angle>) -> Solid {
        ...
        let solid = ffi::topo_ds::Solid(revolved_shape);
    ...
    pub fn fillet(&self, radius: f64) -> Self {
        ...
        for i in 1..=shape_map.Extent() {
            let vertex = ffi::topo_ds::Vertex(shape_map.FindKey(i));
        ...
        let result_face = ffi::topo_ds::Face(result_shape);
    ...
    pub fn chamfer(&self, distance_1: f64) -> Self {
        ...
        for i in 1..=vertex_map.Extent() {
            ...
            ffi::b_rep_fillet_api::BRepFilletAPI_MakeFillet2d_add_chamfer(
                make_fillet.pin_mut(),
                ffi::topo_ds::Edge(edge_1),
                ffi::topo_ds::Edge(edge_2),
                distance_1,
                distance_2,
            );
        }
        ...
        let result_face = ffi::topo_ds::Face(filleted_shape);
    ...
    pub fn offset(&self, distance: f64, join_type: JoinType) -> Self {
        ...
        let result_wire = ffi::topo_ds::Wire(offset_shape);
    ...
    pub fn sweep_along(&self, path: &Wire) -> Solid {
        ...
        let result_solid = ffi::topo_ds::Solid(pipe_shape);
    ...
    pub fn union(&self, other: &Face) -> CompoundFace {
        ...
        let compound = ffi::topo_ds::Compound(fuse_shape);
    ...
    pub fn intersect(&self, other: &Face) -> CompoundFace {
        ...
        let compound = ffi::topo_ds::Compound(common_shape);
    ...
    pub fn subtract(&self, other: &Face) -> CompoundFace {
        ...
        let compound = ffi::topo_ds::Compound(cut_shape);
...
impl From<Face> for CompoundFace {
    fn from(face: Face) -> Self {
        ...
        Self::from_compound(ffi::topo_ds::Compound(&compound_shape))
    }
}
...
impl CompoundFace {
    ...
    pub fn clean(&self) -> Self {
        ...
        let compound = ffi::topo_ds::Compound(&shape.inner);
